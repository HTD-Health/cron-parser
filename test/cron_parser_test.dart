...
void main() {
  ...
  test('Cron().parse() throws exception for invalid cron string', () {
    ...
    expect(() => Cron().parse("* * *"), throwsA(TypeMatcher<AssertionError>()));
    expect(
        () => Cron().parse("* * * *"), throwsA(TypeMatcher<AssertionError>()));
    expect(() => Cron().parse("-1 * * * *"),
        throwsA(TypeMatcher<AssertionError>()));
    expect(() => Cron().parse("60 * * * *"),
        throwsA(TypeMatcher<AssertionError>()));
    expect(() => Cron().parse("* -1 * * *"),
        throwsA(TypeMatcher<AssertionError>()));
    expect(() => Cron().parse("* 24 * * *"),
        throwsA(TypeMatcher<AssertionError>()));
    expect(() => Cron().parse("* * 0 * *"),
        throwsA(TypeMatcher<AssertionError>()));
    expect(() => Cron().parse("* * 32 * *"),
        throwsA(TypeMatcher<AssertionError>()));
    expect(() => Cron().parse("* * * 0 *"),
        throwsA(TypeMatcher<AssertionError>()));
    expect(() => Cron().parse("* * * 13 *"),
        throwsA(TypeMatcher<AssertionError>()));
    expect(() => Cron().parse("* * * * -1"),
        throwsA(TypeMatcher<AssertionError>()));
    expect(() => Cron().parse("* * * * 8"),
        throwsA(TypeMatcher<AssertionError>()));
    expect(() => Cron().parse("-1-2 * * * *"),
        throwsA(TypeMatcher<AssertionError>()));
    expect(() => Cron().parse("* -1-2 * * *"),
        throwsA(TypeMatcher<AssertionError>()));
    expect(() => Cron().parse("* * -1-2 * *"),
  ...
  group("Cron().parse() delivers", () {
    ...
    test('next month starting from date', () {
      ...
      expect(
          cronIterator.next(), equals(DateTime(date.year, date.month + 1, 1)));
      expect(
          cronIterator.next(), equals(DateTime(date.year, date.month + 2, 1)));
      expect(
          cronIterator.next(), equals(DateTime(date.year, date.month + 3, 1)));
      expect(
          cronIterator.next(), equals(DateTime(date.year, date.month + 4, 1)));
      expect(
          cronIterator.next(), equals(DateTime(date.year, date.month + 5, 1)));
    });
    ...
    test('next minutes selection starting from date', () {
      DateTime date = normalizedDate(DateTime(2020, 03, 31));
      var cronIterator = Cron().parse("0,1,2,3 * * * *", date);
      expect(cronIterator.next(), equals(date.add(Duration(minutes: 1))));
      expect(cronIterator.next(), equals(date.add(Duration(minutes: 2))));
      expect(cronIterator.next(), equals(date.add(Duration(minutes: 3))));
      expect(cronIterator.next(), equals(date.add(Duration(minutes: 60))));
    ...
    test('next hours selection starting from date', () {
      DateTime date = normalizedDate(DateTime(2020, 03, 31));
      var cronIterator = Cron().parse("0 0,1,2,3 * * *", date);
      expect(cronIterator.next(), equals(date.add(Duration(hours: 1))));
      expect(cronIterator.next(), equals(date.add(Duration(hours: 2))));
      expect(cronIterator.next(), equals(date.add(Duration(hours: 3))));
      expect(cronIterator.next(), equals(date.add(Duration(hours: 24))));
    ...
    test('next month selection starting from date', () {
      DateTime date = normalizedDate(DateTime(2020, 03, 29));
      var cronIterator = Cron().parse("0 0 4 1,2,3 *", date);
      expect(cronIterator.next(), equals(DateTime(2021, 01, 4)));
      expect(cronIterator.next(), equals(DateTime(2021, 02, 4)));
      expect(cronIterator.next(), equals(DateTime(2021, 03, 4)));
      expect(cronIterator.next(), equals(DateTime(2022, 01, 4)));
    ...
    test('next weekdays range starting from date', () {
      DateTime date = normalizedDate(DateTime(2020, 04, 01));
      ...
      expect(cronIterator.next(), equals(DateTime(2020, 04, 7)));
      expect(cronIterator.next(), equals(DateTime(2020, 04, 8)));
      expect(cronIterator.next(), equals(DateTime(2020, 04, 9)));
      expect(cronIterator.next(), equals(DateTime(2020, 04, 10)));
      expect(cronIterator.next(), equals(DateTime(2020, 04, 12)));
    });

    test('next weekdays selection starting from date', () {
      DateTime date = normalizedDate(DateTime(2020, 04, 01));
      var cronIterator = Cron().parse("0 0 * * 0,1,2,3,4,5", date);
      expect(cronIterator.next(), equals(DateTime(2020, 04, 2)));
      expect(cronIterator.next(), equals(DateTime(2020, 04, 3)));
      expect(cronIterator.next(), equals(DateTime(2020, 04, 5)));
      expect(cronIterator.next(), equals(DateTime(2020, 04, 6)));
    ...
    test('next month interval starting from date', () {
      ...
      expect(cronIterator.next(), equals(DateTime(2020, 10, 1)));
    });
    ...
    test('next weekdays interval starting from date', () {
      ...
      expect(cronIterator.next(), equals(DateTime(2020, 4, 9)));
    });
  });
  ...
  group("Cron().parse() handles timezone DST changes correctly", () {
    test(
        ...
        () {
      DateTime date = normalizedDate(DateTime(2020, 3, 29, 1));
      var cronIterator = Cron().parse("0 * * * *", date);
      expect(cronIterator.next(), equals(DateTime(2020, 3, 29, 3)));
      expect(cronIterator.next(), equals(DateTime(2020, 3, 29, 4)));
      expect(cronIterator.next(), equals(DateTime(2020, 3, 29, 5)));
    });

    test('test', () {
      DateTime startDate = DateTime(2020, 4, 01);
      var cronIterator = Cron().parse("0 * * * *", startDate);
      expect(cronIterator.next(), equals(DateTime(2020, 4, 01, 1)));
      expect(cronIterator.next(), equals(DateTime(2020, 4, 01, 2)));
